        ...
        <div class="sidebar-form">
            ...
            <div class="project-meta-info">
                <div class="meta-item">
                    ...
                    <span>{{ $project->created_at->format('M d, Y \a\t H:i') }}</span>
                </div>
                <div class="meta-item">
                    <strong>Updated:</strong>
                    <span>{{ $project->updated_at->format('M d, Y \a\t H:i') }}</span>
                </div>
            </div>
            ...
            <div class="form-actions">
                ...
                <form method="POST" action="{{ route('admin.projects.destroy', $project->id) }}" style="display: inline-block; width: 100%;" onsubmit="return confirm('Are you sure you want to delete this project? This action cannot be undone.')">
                    @csrf
                    @method('DELETE')
